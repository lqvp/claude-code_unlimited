...
export async function showSetupScreens(root: Root, permissionMode: PermissionMode, allowDangerouslySkipPermissions: boolean, commands?: Command[], claudeInChrome?: boolean, devChannels?: ChannelEntry[]): Promise<boolean> {
  ...
  // Keep the trust-dependent startup work below, including external include
  // checks and other follow-up initialization that previously ran after trust.
  // In this fork, interactive startup also skips the workspace trust prompt
  // and proceeds directly into the trust-dependent initialization path below.
