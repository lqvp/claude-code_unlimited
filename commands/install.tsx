...
import { checkInstall, cleanupNpmInstallations, cleanupShellAliases } from '../utils/nativeInstaller/index.js';
  ...
  useEffect(() => {
    async function run() {
      try {
        ...
        const destExe = join(binDir, isWindows ? 'claude.exe' : 'claude');
