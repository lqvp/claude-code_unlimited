...
import { type EffortLevel, type EffortValue, getDisplayedEffortLevel, getEffortEnvOverride, getEffortValueDescription, isEffortLevel, toPersistableEffort } from '../../utils/effort.js';
...
function EffortSliderStep(t0) {
  ...
  return <EffortSlider model={model} currentEffort={effortValue} onSelect={handleSelect} onCancel={handleCancel} />;
}
