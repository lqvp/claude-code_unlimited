...
export function ModelPicker(t0) {
  ...
  const focusedSupportsXhigh = (() => {
    const m = resolveOptionModel(focusedValue);
    return m ? modelSupportsXhighEffort(m) : false;
  })();
  let t9;
  if ($[23] !== focusedValue) {
  ...
  const displayEffort = effort === "max" && !focusedSupportsMax ? "high" : effort === "xhigh" && !focusedSupportsXhigh ? "high" : effort;
  let t10;
