...
export function getAnthropicApiKeyWithSource(
  ...
  // Active API config takes priority over everything except bare mode
  const activeApiConfig = getActiveApiOverride()
  if (activeApiConfig) {
    return activeApiConfig.apiKey
      ? { key: activeApiConfig.apiKey, source: 'ANTHROPIC_API_KEY' }
